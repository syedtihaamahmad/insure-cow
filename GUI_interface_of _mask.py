# -*- coding: utf-8 -*-
"""
Created on Tue Aug 24 00:14:12 2021
...
def mark_region(image):
    ...
    layout_sliders = [
        ...
        [
            sg.Text('Show the region on input image'), sg.Button('Show')
        ]
    ]
    ...
    while True:
        ...
        output_image = mark_region(image=image_bw, alpha=alpha, beta=beta, gamma=(gamma/100),
...
def mark_region_method(image, alpha, beta, gamma, contour_area):
